 ...
 *
 * @author lance
 * @date 8/25/2021 10:02
 */
@UtilityClass
public class DateUtil {
  public static final String DATE_PATH = "yyyyMM";
  ...
  public static String secondToTime(Long second) {
    ...
    second = second % 60;
    if (days > 0) {
      return String.format("%d天%d小时%d分%d秒", days, hours, minutes, second);
    } else {
